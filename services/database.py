...
# Railway Postgres exposes DATABASE_URL directly.
# Fallback to local SQLite for testing without Postgres.
if not DATABASE_URL:
    DATABASE_URL = "sqlite:///data/tickets.db"

# Some providers give "postgres://", normalize to "postgresql://"
